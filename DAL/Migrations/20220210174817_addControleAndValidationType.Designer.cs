...
namespace DAL.Migrations
{
    ...
    [Migration("20220210174817_addControleAndValidationType")]
    partial class addControleAndValidationType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.IntegrationConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IntegrationConfiguration");
                });

            modelBuilder.Entity("DAL.Models.IntegrationsTransactions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("IntegrationConfigurationId")
                        .HasColumnType("int");

                    b.Property<string>("ResponseBody")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ResuestBody")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("IntegrationsTransactions");
                });
            ...
            modelBuilder.Entity("DAL.Models.Organization", b =>
                {
                    ...
                    b.Property<string>("IntegrationProductionURL")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TestingProductionURL")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.SmartConfigurations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SmartConfigurations");
                });

            modelBuilder.Entity("DAL.Models.StatusType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.IntegrationConfiguration", b =>
                {
                    b.HasOne("DAL.Models.Organization", "Organization")
                        .WithOne("IntegrationConfiguration")
                        .HasForeignKey("DAL.Models.IntegrationConfiguration", "OrganizationId");
            ...
            modelBuilder.Entity("DAL.Models.IntegrationsTransactions", b =>
                {
                    b.HasOne("DAL.Models.IntegrationConfiguration", "IntegrationConfiguration")
                        .WithMany("IntegrationsTransactions")
            ...
            modelBuilder.Entity("DAL.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("DAL.Models.StatusType", "StatusType")
                        .WithMany("reservations")
            ...
            modelBuilder.Entity("DAL.Models.IntegrationConfiguration", b =>
                {
                    b.Navigation("IntegrationsTransactions");
                });
